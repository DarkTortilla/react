...
export default function Header({ cart,removeFromCart, increaseQuantity,decreaseQuantity, resetCart }) {
    //State derivado
                    ...
                    <nav className="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
                        <div className="carrito">
                            ...
                            <div id="carrito" className="bg-white p-3">
                                ...
                                <button onClick={()=>resetCart()} className="btn btn-dark w-100 mt-3 p-2">
                                    Vaciar Carrito
                                </button>
                            </div>
                        </div>
